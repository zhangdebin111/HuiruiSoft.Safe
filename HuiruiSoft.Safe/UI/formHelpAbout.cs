...
namespace HuiruiSoft.Safe
{
     public partial class formHelpAbout : System.Windows.Forms.Form
     {
          ...
          protected override void OnLoad(System.EventArgs args)
          {
               ...
               if (!base.DesignMode)
               {
                    ...
                    var tmpAssembly = System.Reflection.Assembly.GetAssembly(typeof(ResourceFinder));
                    this.flashBar.Title = ApplicationDefines.ProductName;
                    this.flashBar.ForeColor = System.Drawing.Color.WhiteSmoke;
                    this.flashBar.Message = string.Format("{0} {1}", SafePassResource.Version, tmpAssembly.GetName().Version);
                    this.pictureBox1.Image = HuiruiSoft.Safe.Properties.Resources.LockWindow;
               }
          }
          ...
          private void InitializeComponent( )
          {
               ...
               // buttonClose
               // 
               this.buttonClose.Location = new System.Drawing.Point(636, 446);
               ...
               this.flashBar.Size = new System.Drawing.Size(873, 130);
               this.flashBar.StartColor = System.Drawing.Color.RoyalBlue;
               this.flashBar.TabIndex = 29;
    ...
    "r later.";
               ...
               this.linkLicense.Location = new System.Drawing.Point(157, 332);
               ...
               this.linkHomepage.Location = new System.Drawing.Point(157, 285);
               ...
               this.linkHomepage.TabIndex = 33;
               this.linkHomepage.TabStop = true;
               this.linkHomepage.Text = "Website:";
               // 
               // pictureBox1
               // 
               this.pictureBox1.Image = global::HuiruiSoft.Safe.Properties.Resources.LockWindow;

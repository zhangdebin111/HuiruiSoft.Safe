     ...
     public partial class formHelpAbout : System.Windows.Forms.Form
     {
          ...
          protected override void OnLoad(System.EventArgs args)
          {
               ...
               if (!base.DesignMode)
               {
                    ...
                    var tmpHomepageUrl = string.Format("{0}", ApplicationDefines.HomepageUrl);
                    if (string.IsNullOrEmpty(tmpHomepageUrl))
                    {
                         this.linkHomepage.Text = string.Empty;
                    }
                    else
                    {
                    ...
                    var tmpOpenSource = string.Format("{0}", ApplicationDefines.OpenSourceUrl);
                    if (string.IsNullOrEmpty(tmpOpenSource))
                    {
                         this.linkOpenSource.Text = string.Empty;
                    }
                    else
                    {
                         this.linkOpenSource.Text = tmpOpenSource;
                         this.linkOpenSource.Links.Add(0, tmpOpenSource.Length, tmpOpenSource);
                    }

                    var tmpLicenseUrl = string.Format("{0}", ApplicationDefines.LicenseUrl);

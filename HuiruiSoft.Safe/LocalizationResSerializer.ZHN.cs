...
namespace HuiruiSoft.Safe.Localization
{
     public static class LocalizationResSerializerZHN
     {
          ...
          public static bool SaveLocalResources()
          {
               ...
               tmpGeneralLocalStrings.Add(new LocalizedStringItem() { Name = "SearchResult", Value = @"搜索结果" });
               ...
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportXML1xFilter", Value = @"SafePass XML(*.xml)|*.xml" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportExcelFilter", Value = @"Excel workbook(*.xlsx)|*.xlsx" });
               ...
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowButtonSelectAll", Value = @"全部选择" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowButtonUnSelected", Value = @"反向选择" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowButtonSelectNone", Value = @"全部取消" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowButtonStartImport", Value = @"开始导入" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowCheckBoxCompare", Value = @"比较当前数据库" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowLabelPromptNotFound", Value = @"表示当前数据库里不存在此记录" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowLabelPromptUnequal", Value  = @"表示与当前数据库的记录相比较有差异" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowMessageImportProgress", Value = @"正在导入:{0}" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ImportWindowMessageImportFinished", Value = @"文件“{0}”导入完成。" });
               ...
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ExportWindowDialogTitleFailed", Value = @"导出失败" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ExportWindowDialogTitleSuccess", Value = @"导出成功" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ExportWindowDialogMessageFailed", Value = @"导出失败！" });
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "ExportWindowDialogMessageSuccess", Value = @"数据已成功导出至文件：{0}{1}" });
               ...
               tmpWindowLocalStrings.Add(new LocalizedStringItem() { Name = "DataGridAccountColumnSelected", Value = @"选择" });
